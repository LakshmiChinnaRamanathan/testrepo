<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ taglib prefix = "my1" u <%@ taglib prefix = "my1" uri = "http://java.sun.com/jsp/jstl/core" %>
    <%@ taglib prefix = "my2" uri = "http://www.springframework.org/tags/form" %>ri = "http://java.sun.com/jsp/jstl/core" %>
